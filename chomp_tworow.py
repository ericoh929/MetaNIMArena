...
def play_two_row_chomp_game(num_columns=8, verbose=False):
    with open(f'/home/jihwan/NashIP/result/Chomp_R/{args.agent1_model}_{args.agent1_prompt}_{n_step_lookahead}_{args.agent2_model}_{args.agent2_prompt}.txt', 'a') as f:

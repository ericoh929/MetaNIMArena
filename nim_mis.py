...
genai.configure(api_key='AIzaSyDski0AyeLpvymxWRork6iAKAxbK71l2Z4')
...
def get_move_with_debate_2(agent1, agent2, judge_agent, remaining_items, debate_rounds=3):
    ...
    for round_num in range(1, debate_rounds + 1):
        ...
        # 2. 긍정측(agent1)이 부정측의 평가를 듣고 자신의 의견을 재정제
...
def play_nim_game(total_items, max_take, verbose=False):
    with open(f'/home/jihwan/NashIP/result/BR31_M/{args.agent1_model}_{args.agent1_prompt}_{n_step_lookahead}_{args.agent2_model}_{args.agent2_prompt}.txt', 'a') as f:

...
AGENT1_MODELS=("gpt-4o-mini" "gpt-4o" "gpt-3.5-turbo")
AGENT2_MODELS=("gpt-4o")
AGENT1_PROMPTS=("basic" "debate" "self_reflection") #("bias_mitigate_debate") #"debate" "self_reflection" "self_consistency" "basic" "self_consistency"
AGENT2_PROMPTS=("basic")
LOOK_AHEAD_VALUES=(3)
NUM_GAMES_VALUES=(50)

# Output directory for logs
OUTPUT_DIR="/home/jihwan/NashIP/result/2K"
mkdir -p "$OUTPUT_DIR"
            ...
            for agent2_prompt in "${AGENT2_PROMPTS[@]}"; do
                for look_ahead in "${LOOK_AHEAD_VALUES[@]}"; do
                    for num_games in "${NUM_GAMES_VALUES[@]}"; do
                        ...
                        python3 /home/jihwan/NashIP/kayles_two.py \

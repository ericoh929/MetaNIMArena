...
AGENT1_MODELS=("gemini-1.5-pro" "gemini-1.5-flash" "gpt-4o-mini" "gpt-3.5-turbo")
AGENT2_MODELS=("gpt-4o")
AGENT1_PROMPTS=("self_play_debate_exp") #("self_play_debate" "basic" "debate" "self_reflection" "self_consistency")
            ...
            for agent2_prompt in "${AGENT2_PROMPTS[@]}"; do
                for look_ahead in "${LOOK_AHEAD_VALUES[@]}"; do
                    for num_games in "${NUM_GAMES_VALUES[@]}"; do
                        ...
                        python3 /home/jihwan/NashIP/fibonacci_reasoning_first.py \

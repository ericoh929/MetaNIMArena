...
AGENT1_MODELS=("gpt-4o") #("gpt-4o-mini" "gpt-4o" "gpt-4o-large")
AGENT2_MODELS=("gpt-4o")
AGENT1_PROMPTS=("self_consistency") #("bias_mitigate_debate") #original_vs_harmonized_debate "basic" "debate" "self_reflection" "self_consistency"
AGENT2_PROMPTS=("basic")
LOOK_AHEAD_VALUES=(0)
NUM_GAMES_VALUES=(50)

# Output directory for logs
OUTPUT_DIR="/home/jihwan/NashIP/result/BR31"
mkdir -p "$OUTPUT_DIR"
            ...
            for agent2_prompt in "${AGENT2_PROMPTS[@]}"; do
                for look_ahead in "${LOOK_AHEAD_VALUES[@]}"; do
                    for num_games in "${NUM_GAMES_VALUES[@]}"; do
                        ...
                        python3 /home/jihwan/NashIP/br31_first.py \

...
AGENT1_PROMPTS=("dreamad") #("simple" "basic" "self_reflection" "self_consistency" "debate" "dreamad") #("bias_mitigate_debate") #"debate" "self_reflection" "self_consistency" "basic" "self_consistency"
AGENT2_PROMPTS=("basic")
LOOK_AHEAD_VALUES=(3 4)
NUM_GAMES_VALUES=(50)

# Output directory for logs
OUTPUT_DIR="/home/jihwan/NashIP/result/QUEEN"
mkdir -p "$OUTPUT_DIR"
            ...
            for agent2_prompt in "${AGENT2_PROMPTS[@]}"; do
                for look_ahead in "${LOOK_AHEAD_VALUES[@]}"; do
                    for num_games in "${NUM_GAMES_VALUES[@]}"; do
                        ...
                        python3 -u /home/jihwan/NashIP/corner_queen.py \

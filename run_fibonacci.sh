...
AGENT1_MODELS=("gemini-1.5-flash" "gpt-4o-mini")
AGENT2_MODELS=("gpt-4o")
AGENT1_PROMPTS=("diverse_reflection") #("self_play_debate" "basic" "debate" "self_reflection" "self_consistency")
                ...
                for look_ahead in "${LOOK_AHEAD_VALUES[@]}"; do
                    for temperature in "${TEMPERATURE_VALUES[@]}"; do
                        for num_games in "${NUM_GAMES_VALUES[@]}"; do
                            ...
                            LOG_FILE="$OUTPUT_DIR/${agent1_model}_${agent1_prompt}_${look_ahead}_${temperature}_${agent2_model}_${agent2_prompt}.txt"

...
AGENT1_PROMPTS=("basic" "debate" "self_reflection" "self_consistency") #("self_play_debate" "basic" "debate" "self_reflection" "self_consistency")
            ...
            for agent2_prompt in "${AGENT2_PROMPTS[@]}"; do
                for look_ahead in "${LOOK_AHEAD_VALUES[@]}"; do
                    for num_games in "${NUM_GAMES_VALUES[@]}"; do
                        ...
                        python3 /home/jihwan/NashIP/fibonacci_mis_first.py \
